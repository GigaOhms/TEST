...
class AnimationPlot:
    ...
    def getPlotFormat(self):
        ax.set_ylim([0, 300])                              # Set Y axis limit of plot
...
ser = serial.Serial(portName, 115200)                       # Establish Serial object with COM port and BAUD rate to match Arduino Port/rate                                              # Matplotlib Animation Fuction that takes takes care of real time plot.
